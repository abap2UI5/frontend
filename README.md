> ⚙️ **Generated branch `cloud_v2`** — built from [`main`](../../tree/main) by the `build_cloud_v2` workflow. Do not commit here, changes belong into `main`. Frontend state: `abap2UI5/abap2UI5@4690f29b25d2` (framework 1.142.0) — see `VERSION`.
