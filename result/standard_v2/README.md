> ⚙️ **Generated branch `standard_v2`** — built in [abap2UI5/abap2UI5](https://github.com/abap2UI5/abap2UI5) by its `frontend_deploy` workflow and pushed here. Do not commit in this repository; changes belong into abap2UI5. Frontend state: `abap2UI5/abap2UI5@56ff2a100f79` (framework 1.143.0) — see `VERSION`.
