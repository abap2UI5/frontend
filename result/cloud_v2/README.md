> ⚙️ **Generated branch `cloud_v2`** — built in [abap2UI5/abap2UI5](https://github.com/abap2UI5/abap2UI5) by its `frontend_deploy` workflow and pushed here. Do not commit in this repository; changes belong into abap2UI5. Frontend state: `abap2UI5/abap2UI5@89b72ce7e55e` (framework 1.144.1) — see `VERSION`.
